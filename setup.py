...
package_installer(name = "modulation_classification",
                  version = "0.1",
                  description  = "Demonstration of a modulation classification system for RFSoC and Ultrascale+ SoC devices",
                  author = "Andrew Maclellan",
                  email = "a.maclellan@strath.ac.uk",
                  license = "BSD 3-Clause License",
                  url = "https://github.com/axdy/rfsoc_modulation_classification.git",
