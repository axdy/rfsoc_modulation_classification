-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/packet_generator/packet_generator_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: packet_generator_axi4_stream_slave
-- Source Path: packet_generator/packet_generator_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY packet_generator_axi4_stream_slave IS
...
END packet_generator_axi4_stream_slave;


ARCHITECTURE rtl OF packet_generator_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT packet_generator_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : packet_generator_fifo_data
    USE ENTITY work.packet_generator_fifo_data(rtl);
...
BEGIN
  u_packet_generator_fifo_data_inst : packet_generator_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
