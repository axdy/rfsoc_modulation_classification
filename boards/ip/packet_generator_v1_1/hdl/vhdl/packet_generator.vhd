-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/packet_generator/packet_generator.vhd
...
ARCHITECTURE rtl OF packet_generator IS
  ...
  COMPONENT packet_generator_reset_sync
  ...
  COMPONENT packet_generator_axi_lite
  ...
  COMPONENT packet_generator_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT packet_generator_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT packet_generator_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : packet_generator_reset_sync
    USE ENTITY work.packet_generator_reset_sync(rtl);

  FOR ALL : packet_generator_axi_lite
    USE ENTITY work.packet_generator_axi_lite(rtl);

  FOR ALL : packet_generator_axi4_stream_slave
    USE ENTITY work.packet_generator_axi4_stream_slave(rtl);

  FOR ALL : packet_generator_dut
    USE ENTITY work.packet_generator_dut(rtl);

  FOR ALL : packet_generator_axi4_stream_master
    USE ENTITY work.packet_generator_axi4_stream_master(rtl);
  ...
  SIGNAL write_capture                    : std_logic;  -- ufix1
  SIGNAL write_captureSize                : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_packet_generator_reset_sync_inst : packet_generator_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_packet_generator_axi_lite_inst : packet_generator_axi_lite
    PORT MAP( reset => reset,
              ...
              write_capture => write_capture,  -- ufix1
              write_captureSize => write_captureSize,  -- ufix16
              reset_internal => reset_internal  -- ufix1
              );

  u_packet_generator_axi4_stream_slave_inst : packet_generator_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_packet_generator_dut_inst : packet_generator_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              dataIn => top_user_data,  -- ufix32
              validIn => validIn_sig,  -- ufix1
              capture => write_capture,  -- ufix1
              captureSize => write_captureSize,  -- ufix16
  ...
  u_packet_generator_axi4_stream_master_inst : packet_generator_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"89282D97");
