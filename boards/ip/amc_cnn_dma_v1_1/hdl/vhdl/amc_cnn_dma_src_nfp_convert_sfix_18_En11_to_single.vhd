-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_nfp_convert_sfix_18_En11_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_nfp_convert_sfix_18_En11_to_single
-- Source Path: ltehdlCNN_AMC/DUT HDL/nfp_convert_sfix_18_En11_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_dma_src_nfp_convert_sfix_18_En11_to_single IS
...
END amc_cnn_dma_src_nfp_convert_sfix_18_En11_to_single;


ARCHITECTURE rtl OF amc_cnn_dma_src_nfp_convert_sfix_18_En11_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(17 DOWNTO 0);  -- sfix18_En11
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(17 DOWNTO 0);  -- ufix18_En11
  SIGNAL Unary_Minus_cast                 : signed(18 DOWNTO 0);  -- sfix19_En11
  SIGNAL Unary_Minus_cast_1               : signed(18 DOWNTO 0);  -- sfix19_En11
  SIGNAL Unary_Minus_out1                 : signed(17 DOWNTO 0);  -- sfix18_En11
  SIGNAL Unary_Minus_out1_dtc             : unsigned(17 DOWNTO 0);  -- ufix18_En11
  SIGNAL Switch_out1                      : unsigned(17 DOWNTO 0);  -- ufix18_En11
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#00000#, 18) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#00000#, 18) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 19);
