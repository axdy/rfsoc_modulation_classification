-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_ParallelMACs_12.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_ParallelMACs_12
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 12
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_ParallelMACs_12 IS
...
END amc_cnn_dma_src_ParallelMACs_12;


ARCHITECTURE rtl OF amc_cnn_dma_src_ParallelMACs_12 IS

  -- Component Declarations
  COMPONENT amc_cnn_dma_src_Weight_Storage_0_block5
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage1_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage2_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage3_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage4_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage5_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage6_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage7_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage8_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage9_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage10_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage11_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage12_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage13_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage14_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage15_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC0_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_dma_src_MAC1_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC2_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC3_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC4_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC5_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC6_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC7_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC8_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC9_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC10_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC11_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC12_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC13_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC14_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC15_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  FOR ALL : amc_cnn_dma_src_Weight_Storage_0_block5
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage_0_block5(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage1_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage1_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage2_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage2_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage3_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage3_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage4_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage4_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage5_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage5_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage6_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage6_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage7_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage7_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage8_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage8_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage9_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage9_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage10_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage10_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage11_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage11_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage12_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage12_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage13_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage13_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage14_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage14_block4(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage15_block4
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage15_block4(rtl);

  FOR ALL : amc_cnn_dma_src_MAC0_block3
    USE ENTITY work.amc_cnn_dma_src_MAC0_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC1_block3
    USE ENTITY work.amc_cnn_dma_src_MAC1_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC2_block3
    USE ENTITY work.amc_cnn_dma_src_MAC2_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC3_block3
    USE ENTITY work.amc_cnn_dma_src_MAC3_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC4_block3
    USE ENTITY work.amc_cnn_dma_src_MAC4_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC5_block3
    USE ENTITY work.amc_cnn_dma_src_MAC5_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC6_block3
    USE ENTITY work.amc_cnn_dma_src_MAC6_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC7_block3
    USE ENTITY work.amc_cnn_dma_src_MAC7_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC8_block3
    USE ENTITY work.amc_cnn_dma_src_MAC8_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC9_block3
    USE ENTITY work.amc_cnn_dma_src_MAC9_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC10_block3
    USE ENTITY work.amc_cnn_dma_src_MAC10_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC11_block3
    USE ENTITY work.amc_cnn_dma_src_MAC11_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC12_block3
    USE ENTITY work.amc_cnn_dma_src_MAC12_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC13_block3
    USE ENTITY work.amc_cnn_dma_src_MAC13_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC14_block3
    USE ENTITY work.amc_cnn_dma_src_MAC14_block3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC15_block3
    USE ENTITY work.amc_cnn_dma_src_MAC15_block3(rtl);
...
BEGIN
  u_Weight_Storage_0 : amc_cnn_dma_src_Weight_Storage_0_block5
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_Weight_Storage1 : amc_cnn_dma_src_Weight_Storage1_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage2 : amc_cnn_dma_src_Weight_Storage2_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage3 : amc_cnn_dma_src_Weight_Storage3_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage4 : amc_cnn_dma_src_Weight_Storage4_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage5 : amc_cnn_dma_src_Weight_Storage5_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage6 : amc_cnn_dma_src_Weight_Storage6_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage7 : amc_cnn_dma_src_Weight_Storage7_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage8 : amc_cnn_dma_src_Weight_Storage8_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage9 : amc_cnn_dma_src_Weight_Storage9_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage10 : amc_cnn_dma_src_Weight_Storage10_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage11 : amc_cnn_dma_src_Weight_Storage11_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage12 : amc_cnn_dma_src_Weight_Storage12_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage13 : amc_cnn_dma_src_Weight_Storage13_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage14 : amc_cnn_dma_src_Weight_Storage14_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage15 : amc_cnn_dma_src_Weight_Storage15_block4
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_MAC0 : amc_cnn_dma_src_MAC0_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC1 : amc_cnn_dma_src_MAC1_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC2 : amc_cnn_dma_src_MAC2_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC3 : amc_cnn_dma_src_MAC3_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC4 : amc_cnn_dma_src_MAC4_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC5 : amc_cnn_dma_src_MAC5_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC6 : amc_cnn_dma_src_MAC6_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC7 : amc_cnn_dma_src_MAC7_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC8 : amc_cnn_dma_src_MAC8_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC9 : amc_cnn_dma_src_MAC9_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC10 : amc_cnn_dma_src_MAC10_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC11 : amc_cnn_dma_src_MAC11_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC12 : amc_cnn_dma_src_MAC12_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC13 : amc_cnn_dma_src_MAC13_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC14 : amc_cnn_dma_src_MAC14_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MAC15 : amc_cnn_dma_src_MAC15_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
