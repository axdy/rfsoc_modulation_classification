-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_Output_Buffer1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_Output_Buffer1
-- Source Path: ltehdlCNN_AMC/DUT HDL/Dense Layer 1/Output Buffer1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_Output_Buffer1 IS
...
END amc_cnn_dma_src_Output_Buffer1;


ARCHITECTURE rtl OF amc_cnn_dma_src_Output_Buffer1 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed18(0 TO 127);  -- sfix18_En10 [128]
  ...
  SIGNAL buffer_rsvd                      : vector_of_signed18(0 TO 127);  -- sfix18 [128]
  SIGNAL reg_flag_next                    : std_logic;
  SIGNAL reg_count_out_next               : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL buffer_next                      : vector_of_signed18(0 TO 127);  -- sfix18_En10 [128]
...
BEGIN
  ...
  Output_Buffer1_output : PROCESS (buffer_rsvd, reg_count_out, reg_flag, validIn, vectorIn_signed)
    ...
    VARIABLE buffer_temp : vector_of_signed18(0 TO 127);
