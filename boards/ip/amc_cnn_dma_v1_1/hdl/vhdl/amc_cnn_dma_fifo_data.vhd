-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_fifo_data
-- Source Path: amc_cnn_dma/amc_cnn_dma_axi4_stream_slave/amc_cnn_dma_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_fifo_data IS
...
END amc_cnn_dma_fifo_data;


ARCHITECTURE rtl OF amc_cnn_dma_fifo_data IS
...
BEGIN
  ...
  u_amc_cnn_dma_fifo_data_classic_ram : amc_cnn_dma_SimpleDualPortRAM_generic
