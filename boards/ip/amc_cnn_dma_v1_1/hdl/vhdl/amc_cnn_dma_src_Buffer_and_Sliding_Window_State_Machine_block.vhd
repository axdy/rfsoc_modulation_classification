-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_Buffer_and_Sliding_Window_State_Machine_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_Buffer_and_Sliding_Window_State_Machine_block
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 2/Buffer and Sliding Window State Machine
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_Buffer_and_Sliding_Window_State_Machine_block IS
...
END amc_cnn_dma_src_Buffer_and_Sliding_Window_State_Machine_block;


ARCHITECTURE rtl OF amc_cnn_dma_src_Buffer_and_Sliding_Window_State_Machine_block IS
