-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_ParallelMACs_0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_ParallelMACs_0
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_ParallelMACs_0 IS
...
END amc_cnn_dma_src_ParallelMACs_0;


ARCHITECTURE rtl OF amc_cnn_dma_src_ParallelMACs_0 IS

  -- Component Declarations
  COMPONENT amc_cnn_dma_src_Weight_Storage_0_block1
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_dma_src_MAC0
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage1_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage2_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage3_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage4_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage5_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage6_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage7_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage8_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage9_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage10_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage11_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage12_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage13_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage14_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_Weight_Storage15_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          count_Weights                   :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          weightsOut                      :   OUT   std_logic_vector(17 DOWNTO 0)  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  COMPONENT amc_cnn_dma_src_MAC15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          countWeights                    :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En17
  ...
  FOR ALL : amc_cnn_dma_src_Weight_Storage_0_block1
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage_0_block1(rtl);

  FOR ALL : amc_cnn_dma_src_MAC0
    USE ENTITY work.amc_cnn_dma_src_MAC0(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage1_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage1_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage2_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage2_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage3_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage3_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage4_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage4_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage5_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage5_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage6_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage6_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage7_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage7_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage8_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage8_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage9_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage9_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage10_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage10_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage11_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage11_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage12_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage12_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage13_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage13_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage14_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage14_block(rtl);

  FOR ALL : amc_cnn_dma_src_Weight_Storage15_block
    USE ENTITY work.amc_cnn_dma_src_Weight_Storage15_block(rtl);

  FOR ALL : amc_cnn_dma_src_MAC1
    USE ENTITY work.amc_cnn_dma_src_MAC1(rtl);

  FOR ALL : amc_cnn_dma_src_MAC2
    USE ENTITY work.amc_cnn_dma_src_MAC2(rtl);

  FOR ALL : amc_cnn_dma_src_MAC3
    USE ENTITY work.amc_cnn_dma_src_MAC3(rtl);

  FOR ALL : amc_cnn_dma_src_MAC4
    USE ENTITY work.amc_cnn_dma_src_MAC4(rtl);

  FOR ALL : amc_cnn_dma_src_MAC5
    USE ENTITY work.amc_cnn_dma_src_MAC5(rtl);

  FOR ALL : amc_cnn_dma_src_MAC6
    USE ENTITY work.amc_cnn_dma_src_MAC6(rtl);

  FOR ALL : amc_cnn_dma_src_MAC7
    USE ENTITY work.amc_cnn_dma_src_MAC7(rtl);

  FOR ALL : amc_cnn_dma_src_MAC8
    USE ENTITY work.amc_cnn_dma_src_MAC8(rtl);

  FOR ALL : amc_cnn_dma_src_MAC9
    USE ENTITY work.amc_cnn_dma_src_MAC9(rtl);

  FOR ALL : amc_cnn_dma_src_MAC10
    USE ENTITY work.amc_cnn_dma_src_MAC10(rtl);

  FOR ALL : amc_cnn_dma_src_MAC11
    USE ENTITY work.amc_cnn_dma_src_MAC11(rtl);

  FOR ALL : amc_cnn_dma_src_MAC12
    USE ENTITY work.amc_cnn_dma_src_MAC12(rtl);

  FOR ALL : amc_cnn_dma_src_MAC13
    USE ENTITY work.amc_cnn_dma_src_MAC13(rtl);

  FOR ALL : amc_cnn_dma_src_MAC14
    USE ENTITY work.amc_cnn_dma_src_MAC14(rtl);

  FOR ALL : amc_cnn_dma_src_MAC15
    USE ENTITY work.amc_cnn_dma_src_MAC15(rtl);
...
BEGIN
  u_Weight_Storage_0 : amc_cnn_dma_src_Weight_Storage_0_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_Weight_Storage1 : amc_cnn_dma_src_Weight_Storage1_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage2 : amc_cnn_dma_src_Weight_Storage2_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage3 : amc_cnn_dma_src_Weight_Storage3_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage4 : amc_cnn_dma_src_Weight_Storage4_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage5 : amc_cnn_dma_src_Weight_Storage5_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage6 : amc_cnn_dma_src_Weight_Storage6_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage7 : amc_cnn_dma_src_Weight_Storage7_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage8 : amc_cnn_dma_src_Weight_Storage8_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage9 : amc_cnn_dma_src_Weight_Storage9_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage10 : amc_cnn_dma_src_Weight_Storage10_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage11 : amc_cnn_dma_src_Weight_Storage11_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage12 : amc_cnn_dma_src_Weight_Storage12_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage13 : amc_cnn_dma_src_Weight_Storage13_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage14 : amc_cnn_dma_src_Weight_Storage14_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
  ...
  u_Weight_Storage15 : amc_cnn_dma_src_Weight_Storage15_block
    PORT MAP( clk => clk,
              enb => enb,
              count_Weights => std_logic_vector(countWeights),  -- ufix5
