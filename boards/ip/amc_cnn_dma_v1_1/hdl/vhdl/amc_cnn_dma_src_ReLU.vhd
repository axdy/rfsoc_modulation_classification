-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_ReLU.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_ReLU
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 1/ReLU
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_ReLU IS
...
END amc_cnn_dma_src_ReLU;


ARCHITECTURE rtl OF amc_cnn_dma_src_ReLU IS

  -- Signals
  SIGNAL in_signed                        : vector_of_signed18(0 TO 63);  -- sfix18_En13 [64]
  SIGNAL out_tmp                          : vector_of_signed18(0 TO 63);  -- sfix18_En13 [64]
...
BEGIN
  ...
  ReLU_output : PROCESS (in_signed)
    ...
    VARIABLE relu1 : vector_of_signed18(0 TO 63);
  BEGIN
