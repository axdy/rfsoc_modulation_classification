-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_adder_0_block
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_adder_0_block IS
...
END amc_cnn_dma_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_dma_src_adder_0_block IS
  ...
  SIGNAL s_1                              : signed(33 DOWNTO 0);  -- sfix34_En19
  ...
  SIGNAL In1_signed                       : signed(17 DOWNTO 0);  -- sfix18_En19
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg : vector_of_signed18(0 TO 1);  -- sfix18 [2]
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed18(0 TO 1);  -- sfix18_En19 [2]
  SIGNAL In1_1                            : signed(17 DOWNTO 0);  -- sfix18_En19
  SIGNAL Multiply_Accumulate_multiply_out : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_out1         : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_add_fb_in    : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_multiplyAdd_out : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_out1_1       : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg : vector_of_signed34(0 TO 1);  -- sfix34 [2]
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg_next : vector_of_signed34(0 TO 1);  -- sfix34_En19 [2]
  SIGNAL Multiply_Accumulate_out1_2       : signed(33 DOWNTO 0);  -- sfix34_En19
  SIGNAL Data_Type_Conversion_out1        : signed(17 DOWNTO 0);  -- sfix18_En14
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_2(22 DOWNTO 5);
