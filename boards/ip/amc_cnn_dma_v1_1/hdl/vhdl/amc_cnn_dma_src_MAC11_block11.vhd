-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_src_MAC11_block11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_src_MAC11_block11
-- Source Path: ltehdlCNN_AMC/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 6/MAC11
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_src_MAC11_block11 IS
...
END amc_cnn_dma_src_MAC11_block11;


ARCHITECTURE rtl OF amc_cnn_dma_src_MAC11_block11 IS
  ...
  SIGNAL s_1                              : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_not1_out     : std_logic;
  SIGNAL switch_compare_1_1               : std_logic;
  SIGNAL samplesIn_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL s_2                              : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Multiply_Accumulate_input_mux_out : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL countWeights_signed              : signed(17 DOWNTO 0);  -- sfix18_En17
  SIGNAL Multiply_Accumulate_multiply_out : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_out1         : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_add_fb_in    : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_multiplyAdd_out : signed(35 DOWNTO 0);  -- sfix36_En30
  SIGNAL Multiply_Accumulate_out1_1       : signed(35 DOWNTO 0);  -- sfix36_En30
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out1 <= to_signed(0, 36);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out1_1 <= to_signed(0, 36);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_1(34 DOWNTO 17);
