-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_fifo_data_OUT
-- Source Path: amc_cnn_dma/amc_cnn_dma_axi4_stream_master/amc_cnn_dma_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_dma_fifo_data_OUT IS
...
END amc_cnn_dma_fifo_data_OUT;


ARCHITECTURE rtl OF amc_cnn_dma_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT amc_cnn_dma_SimpleDualPortRAM_generic
  ...
  FOR ALL : amc_cnn_dma_SimpleDualPortRAM_generic
    USE ENTITY work.amc_cnn_dma_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_amc_cnn_dma_fifo_data_OUT_classic_ram_generic : amc_cnn_dma_SimpleDualPortRAM_generic
