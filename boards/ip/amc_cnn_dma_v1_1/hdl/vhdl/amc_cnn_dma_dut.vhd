-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/amc_cnn_dma_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_dma_dut
-- Source Path: amc_cnn_dma/amc_cnn_dma_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF amc_cnn_dma_dut IS

  -- Component Declarations
  COMPONENT amc_cnn_dma_src_DUT_HDL
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_dma_src_DUT_HDL
    USE ENTITY work.amc_cnn_dma_src_DUT_HDL(rtl);
...
BEGIN
  u_amc_cnn_dma_src_DUT_HDL : amc_cnn_dma_src_DUT_HDL
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
