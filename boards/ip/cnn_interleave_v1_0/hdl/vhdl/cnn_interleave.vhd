-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/cnn_interleave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cnn_interleave
-- Source Path: cnn_interleave
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF cnn_interleave IS

  -- Component Declarations
  COMPONENT cnn_interleave_reset_sync
  ...
  COMPONENT cnn_interleave_axi_lite
  ...
  COMPONENT cnn_interleave_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT cnn_interleave_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cnn_interleave_reset_sync
    USE ENTITY work.cnn_interleave_reset_sync(rtl);

  FOR ALL : cnn_interleave_axi_lite
    USE ENTITY work.cnn_interleave_axi_lite(rtl);

  FOR ALL : cnn_interleave_axi4_stream_slave
    USE ENTITY work.cnn_interleave_axi4_stream_slave(rtl);

  FOR ALL : cnn_interleave_dut
    USE ENTITY work.cnn_interleave_dut(rtl);

  FOR ALL : cnn_interleave_axi4_stream_master
    USE ENTITY work.cnn_interleave_axi4_stream_master(rtl);
  ...
  SIGNAL interleavedOut_sig_signed        : signed(15 DOWNTO 0);  -- sfix16
...
BEGIN
  u_cnn_interleave_reset_sync_inst : cnn_interleave_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_cnn_interleave_axi_lite_inst : cnn_interleave_axi_lite
  ...
  u_cnn_interleave_axi4_stream_slave_inst : cnn_interleave_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_cnn_interleave_dut_inst : cnn_interleave_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_cnn_interleave_axi4_stream_master_inst : cnn_interleave_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"8935EBBD");
  ...
  interleavedOut_sig_signed <= signed(interleavedOut_sig);

  top_user_data_1 <= unsigned(interleavedOut_sig_signed);
