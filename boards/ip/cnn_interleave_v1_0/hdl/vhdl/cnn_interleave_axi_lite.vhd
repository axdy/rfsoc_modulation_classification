-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/cnn_interleave_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cnn_interleave_axi_lite
-- Source Path: cnn_interleave/cnn_interleave_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cnn_interleave_axi_lite IS
...
END cnn_interleave_axi_lite;


ARCHITECTURE rtl OF cnn_interleave_axi_lite IS

  -- Component Declarations
  COMPONENT cnn_interleave_addr_decoder
  ...
  COMPONENT cnn_interleave_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cnn_interleave_addr_decoder
    USE ENTITY work.cnn_interleave_addr_decoder(rtl);

  FOR ALL : cnn_interleave_axi_lite_module
    USE ENTITY work.cnn_interleave_axi_lite_module(rtl);
...
BEGIN
  u_cnn_interleave_addr_decoder_inst : cnn_interleave_addr_decoder
  ...
  u_cnn_interleave_axi_lite_module_inst : cnn_interleave_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
