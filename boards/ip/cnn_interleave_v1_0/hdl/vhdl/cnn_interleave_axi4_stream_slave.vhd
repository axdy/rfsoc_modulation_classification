-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/cnn_interleave_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cnn_interleave_axi4_stream_slave
-- Source Path: cnn_interleave/cnn_interleave_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cnn_interleave_axi4_stream_slave IS
...
END cnn_interleave_axi4_stream_slave;


ARCHITECTURE rtl OF cnn_interleave_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT cnn_interleave_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cnn_interleave_fifo_data
    USE ENTITY work.cnn_interleave_fifo_data(rtl);
...
BEGIN
  u_cnn_interleave_fifo_data_inst : cnn_interleave_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
