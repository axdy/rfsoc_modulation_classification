-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_dma/hdlsrc/ltehdlCNN_AMC/cnn_interleave_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cnn_interleave_axi4_stream_master
-- Source Path: cnn_interleave/cnn_interleave_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cnn_interleave_axi4_stream_master IS
...
END cnn_interleave_axi4_stream_master;


ARCHITECTURE rtl OF cnn_interleave_axi4_stream_master IS

  -- Component Declarations
  COMPONENT cnn_interleave_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cnn_interleave_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cnn_interleave_fifo_data_OUT
    USE ENTITY work.cnn_interleave_fifo_data_OUT(rtl);

  FOR ALL : cnn_interleave_fifo_TLAST_OUT
    USE ENTITY work.cnn_interleave_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_cnn_interleave_fifo_data_OUT_inst : cnn_interleave_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cnn_interleave_fifo_TLAST_OUT_inst : cnn_interleave_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
