-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_axi_lite.vhd
...
ARCHITECTURE rtl OF DDC_axi_lite IS

  -- Component Declarations
  COMPONENT DDC_addr_decoder
  ...
  FOR ALL : DDC_addr_decoder
    USE ENTITY work.DDC_addr_decoder(rtl);

  FOR ALL : DDC_axi_lite_module
    USE ENTITY work.DDC_axi_lite_module(rtl);
...
BEGIN
  u_DDC_addr_decoder_inst : DDC_addr_decoder
  ...
  u_DDC_axi_lite_module_inst : DDC_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
