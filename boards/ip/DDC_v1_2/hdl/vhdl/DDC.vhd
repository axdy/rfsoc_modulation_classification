-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC.vhd
...
ARCHITECTURE rtl OF DDC IS
  ...
  COMPONENT DDC_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT DDC_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DDC_reset_sync
    USE ENTITY work.DDC_reset_sync(rtl);

  FOR ALL : DDC_axi_lite
    USE ENTITY work.DDC_axi_lite(rtl);

  FOR ALL : DDC_axi4_stream_slave
    USE ENTITY work.DDC_axi4_stream_slave(rtl);

  FOR ALL : DDC_dut
    USE ENTITY work.DDC_dut(rtl);

  FOR ALL : DDC_axi4_stream_master
    USE ENTITY work.DDC_axi4_stream_master(rtl);
...
BEGIN
  u_DDC_reset_sync_inst : DDC_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DDC_axi_lite_inst : DDC_axi_lite
  ...
  u_DDC_axi4_stream_slave_inst : DDC_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DDC_axi4_stream_master_inst : DDC_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"89271AFB");
