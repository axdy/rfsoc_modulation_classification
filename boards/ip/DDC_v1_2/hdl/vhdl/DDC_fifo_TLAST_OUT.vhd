-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_fifo_TLAST_OUT
-- Source Path: DDC/DDC_axi4_stream_master/DDC_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DDC_fifo_TLAST_OUT;


ARCHITECTURE rtl OF DDC_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT DDC_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : DDC_SimpleDualPortRAM_singlebit
    USE ENTITY work.DDC_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_DDC_fifo_TLAST_OUT_classic_ram_singlebit : DDC_SimpleDualPortRAM_singlebit
