-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_axi4_stream_slave
-- Source Path: DDC/DDC_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DDC_axi4_stream_slave IS
...
END DDC_axi4_stream_slave;


ARCHITECTURE rtl OF DDC_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT DDC_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DDC_fifo_data
    USE ENTITY work.DDC_fifo_data(rtl);
...
BEGIN
  u_DDC_fifo_data_inst : DDC_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
