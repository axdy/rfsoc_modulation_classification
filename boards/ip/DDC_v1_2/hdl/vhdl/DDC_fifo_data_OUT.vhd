-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_fifo_data_OUT
-- Source Path: DDC/DDC_axi4_stream_master/DDC_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DDC_fifo_data_OUT;


ARCHITECTURE rtl OF DDC_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT DDC_SimpleDualPortRAM_generic
  ...
  FOR ALL : DDC_SimpleDualPortRAM_generic
    USE ENTITY work.DDC_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DDC_fifo_data_OUT_classic_ram_generic : DDC_SimpleDualPortRAM_generic
