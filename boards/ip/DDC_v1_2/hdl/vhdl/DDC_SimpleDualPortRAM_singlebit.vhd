-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_SimpleDualPortRAM_singlebit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_SimpleDualPortRAM_singlebit
-- Source Path: DDC/DDC_axi4_stream_master/DDC_fifo_TLAST_OUT/DDC_fifo_TLAST_OUT_classic/DDC_SimpleDualPortRAM_singlebit
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DDC_SimpleDualPortRAM_singlebit IS
...
END DDC_SimpleDualPortRAM_singlebit;


ARCHITECTURE rtl OF DDC_SimpleDualPortRAM_singlebit IS
...
BEGIN
  ...
  DDC_SimpleDualPortRAM_singlebit_process: PROCESS (clk)
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS DDC_SimpleDualPortRAM_singlebit_process;
