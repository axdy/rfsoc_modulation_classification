-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_src_FIR_Rate_Conversion_HDL_Optimized2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_src_FIR_Rate_Conversion_HDL_Optimized2
-- Source Path: ddcduc/DDC/FIR Rate Conversion HDL Optimized2
-- Hierarchy Level: 1
-- 
...
ENTITY DDC_src_FIR_Rate_Conversion_HDL_Optimized2 IS
...
END DDC_src_FIR_Rate_Conversion_HDL_Optimized2;


ARCHITECTURE rtl OF DDC_src_FIR_Rate_Conversion_HDL_Optimized2 IS

  -- Component Declarations
  COMPONENT DDC_src_FIR_Rate_Conversion_Controller_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DDC_src_FIR_Rate_Conversion_Filter_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DDC_src_FIR_Rate_Conversion_Controller_block1
    USE ENTITY work.DDC_src_FIR_Rate_Conversion_Controller_block1(rtl);

  FOR ALL : DDC_src_FIR_Rate_Conversion_Filter_block1
    USE ENTITY work.DDC_src_FIR_Rate_Conversion_Filter_block1(rtl);
...
BEGIN
  u_controllerInst : DDC_src_FIR_Rate_Conversion_Controller_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataValid => dataValid,
  ...
  u_filterInst : DDC_src_FIR_Rate_Conversion_Filter_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              data_re => dataIn_re,  -- sfix18_En16
              data_im => dataIn_im,  -- sfix18_En16
              dataValid => dataValid,
              phase => controllerPhaseOut,  -- ufix1
              phaseValid => controllerValidOut,
              request => request,
