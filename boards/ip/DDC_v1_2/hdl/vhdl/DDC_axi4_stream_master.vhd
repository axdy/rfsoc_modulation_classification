-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_axi4_stream_master
-- Source Path: DDC/DDC_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DDC_axi4_stream_master IS
...
END DDC_axi4_stream_master;


ARCHITECTURE rtl OF DDC_axi4_stream_master IS

  -- Component Declarations
  COMPONENT DDC_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DDC_fifo_data_OUT
    USE ENTITY work.DDC_fifo_data_OUT(rtl);

  FOR ALL : DDC_fifo_TLAST_OUT
    USE ENTITY work.DDC_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_DDC_fifo_data_OUT_inst : DDC_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DDC_fifo_TLAST_OUT_inst : DDC_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
