-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DDC_src_FIR_Rate_Conversion_HDL_Optimized1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DDC_src_FIR_Rate_Conversion_HDL_Optimized1
-- Source Path: ddcduc/DDC/FIR Rate Conversion HDL Optimized1
-- Hierarchy Level: 1
-- 
...
ENTITY DDC_src_FIR_Rate_Conversion_HDL_Optimized1 IS
...
END DDC_src_FIR_Rate_Conversion_HDL_Optimized1;


ARCHITECTURE rtl OF DDC_src_FIR_Rate_Conversion_HDL_Optimized1 IS

  -- Component Declarations
  COMPONENT DDC_src_FIR_Rate_Conversion_Controller_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DDC_src_FIR_Rate_Conversion_Filter_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DDC_src_FIR_Rate_Conversion_Controller_block
    USE ENTITY work.DDC_src_FIR_Rate_Conversion_Controller_block(rtl);

  FOR ALL : DDC_src_FIR_Rate_Conversion_Filter_block
    USE ENTITY work.DDC_src_FIR_Rate_Conversion_Filter_block(rtl);
...
BEGIN
  u_controllerInst : DDC_src_FIR_Rate_Conversion_Controller_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataValid => dataValid,
  ...
  u_filterInst : DDC_src_FIR_Rate_Conversion_Filter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
