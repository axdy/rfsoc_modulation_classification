-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_fifo_TLAST
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_slave/cyclicBufferMultirate_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_fifo_TLAST IS
...
END cyclicBufferMultirate_fifo_TLAST;


ARCHITECTURE rtl OF cyclicBufferMultirate_fifo_TLAST IS
...
BEGIN
  ...
  u_cyclicBufferMultirate_fifo_TLAST_classic_ram : cyclicBufferMultirate_SimpleDualPortRAM_singlebit
