-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_fifo_TLAST_OUT
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_master/cyclicBufferMultirate_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_fifo_TLAST_OUT IS
...
END cyclicBufferMultirate_fifo_TLAST_OUT;


ARCHITECTURE rtl OF cyclicBufferMultirate_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : cyclicBufferMultirate_SimpleDualPortRAM_singlebit
    USE ENTITY work.cyclicBufferMultirate_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_cyclicBufferMultirate_fifo_TLAST_OUT_classic_ram_singlebit : cyclicBufferMultirate_SimpleDualPortRAM_singlebit
