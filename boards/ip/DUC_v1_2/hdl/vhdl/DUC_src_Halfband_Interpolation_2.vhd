-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_src_Halfband_Interpolation_2
-- Created: 2023-01-04 14:48:39
...
-- ------------------------------------------------------------
-- 
-- Module: DUC_src_Halfband_Interpolation_2
-- Source Path: /DUC_src_Halfband_Interpolation_2
-- 
-- ------------------------------------------------------------
-- 
...
ENTITY DUC_src_Halfband_Interpolation_2 IS
...
END DUC_src_Halfband_Interpolation_2;


----------------------------------------------------------------
--Module Architecture: DUC_src_Halfband_Interpolation_2
----------------------------------------------------------------
ARCHITECTURE rtl OF DUC_src_Halfband_Interpolation_2 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL DUC_src_Halfband_Interpolation_2_in_regtype_re : signed(17 DOWNTO 0); -- sfix18_En16
  SIGNAL DUC_src_Halfband_Interpolation_2_in_regtype_im : signed(17 DOWNTO 0); -- sfix18_En16
  ...
  SIGNAL DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_re : signed(17 DOWNTO 0); -- sfix18_En16
  SIGNAL DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_im : signed(17 DOWNTO 0); -- sfix18_En16
...
BEGIN
  ...
  phase_1 <= '1' WHEN cur_count = to_unsigned(1, 2) AND enb_1_4_1 = '1' ELSE '0';
  ...
  BEGIN
    ...
    ELSIF clk'event AND clk = '1' THEN
      IF phase_1 = '1' THEN
        delay_pipeline_re(0) <= signed(DUC_src_Halfband_Interpolation_2_in_re);
        delay_pipeline_re(1 TO 19) <= delay_pipeline_re(0 TO 18);
        delay_pipeline_im(0) <= signed(DUC_src_Halfband_Interpolation_2_in_im);
        delay_pipeline_im(1 TO 19) <= delay_pipeline_im(0 TO 18);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  DUC_src_Halfband_Interpolation_2_in_regtype_re <= signed(DUC_src_Halfband_Interpolation_2_in_re);
  DUC_src_Halfband_Interpolation_2_in_regtype_im <= signed(DUC_src_Halfband_Interpolation_2_in_im);
  ...
  BEGIN
    IF reset = '1' THEN
      DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_re <= (OTHERS => '0');
      DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_im <= (OTHERS => '0');
      product_mux_20_pipe <= (OTHERS => '0');
      product_20_re_pipe_re <= (OTHERS => '0');
      product_20_re_pipe_im <= (OTHERS => '0');
    ELSIF clk'event AND clk = '1' THEN
      IF enb_1_4_1 = '1' THEN
        DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_re <= DUC_src_Halfband_Interpolation_2_in_regtype_re;
        DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_im <= DUC_src_Halfband_Interpolation_2_in_regtype_im;
        product_mux_20_pipe <= product_mux_20;

        product_20_re_pipe_re <= DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_re * product_mux_20_pipe;
        product_20_re_pipe_im <= DUC_src_Halfband_Interpolation_2_in_regtype_re_pipe_im * product_mux_20_pipe;
  ...
  muxout_re <= output_typeconvert_re WHEN ( enb_1_4_1 = '1' ) ELSE
               regout_re;
  muxout_im <= output_typeconvert_im WHEN ( enb_1_4_1 = '1' ) ELSE
               regout_im;
  -- Assignment Statements
  DUC_src_Halfband_Interpolation_2_out_re <= std_logic_vector(muxout_re);
  DUC_src_Halfband_Interpolation_2_out_im <= std_logic_vector(muxout_im);
END rtl;
