-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_SimpleDualPortRAM_singlebit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUC_SimpleDualPortRAM_singlebit
-- Source Path: DUC/DUC_axi4_stream_master/DUC_fifo_TLAST_OUT/DUC_fifo_TLAST_OUT_classic/DUC_SimpleDualPortRAM_singlebit
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DUC_SimpleDualPortRAM_singlebit IS
...
END DUC_SimpleDualPortRAM_singlebit;


ARCHITECTURE rtl OF DUC_SimpleDualPortRAM_singlebit IS
...
BEGIN
  ...
  DUC_SimpleDualPortRAM_singlebit_process: PROCESS (clk)
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS DUC_SimpleDualPortRAM_singlebit_process;
