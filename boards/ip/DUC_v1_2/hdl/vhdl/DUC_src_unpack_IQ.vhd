-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_src_unpack_IQ.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUC_src_unpack_IQ
-- Source Path: ddcduc/DUC/unpack_IQ
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DUC_src_unpack_IQ;


ARCHITECTURE rtl OF DUC_src_unpack_IQ IS
