-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUC_fifo_data_OUT
-- Source Path: DUC/DUC_axi4_stream_master/DUC_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DUC_fifo_data_OUT;


ARCHITECTURE rtl OF DUC_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT DUC_SimpleDualPortRAM_generic
  ...
  FOR ALL : DUC_SimpleDualPortRAM_generic
    USE ENTITY work.DUC_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DUC_fifo_data_OUT_classic_ram_generic : DUC_SimpleDualPortRAM_generic
