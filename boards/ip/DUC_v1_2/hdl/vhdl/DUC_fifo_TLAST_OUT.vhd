-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUC_fifo_TLAST_OUT
-- Source Path: DUC/DUC_axi4_stream_master/DUC_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DUC_fifo_TLAST_OUT;


ARCHITECTURE rtl OF DUC_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT DUC_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : DUC_SimpleDualPortRAM_singlebit
    USE ENTITY work.DUC_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_DUC_fifo_TLAST_OUT_classic_ram_singlebit : DUC_SimpleDualPortRAM_singlebit
