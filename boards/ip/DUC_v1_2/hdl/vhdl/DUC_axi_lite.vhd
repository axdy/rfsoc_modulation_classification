-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_axi_lite.vhd
...
ARCHITECTURE rtl OF DUC_axi_lite IS

  -- Component Declarations
  COMPONENT DUC_addr_decoder
  ...
  FOR ALL : DUC_addr_decoder
    USE ENTITY work.DUC_addr_decoder(rtl);

  FOR ALL : DUC_axi_lite_module
    USE ENTITY work.DUC_axi_lite_module(rtl);
...
BEGIN
  u_DUC_addr_decoder_inst : DUC_addr_decoder
  ...
  u_DUC_axi_lite_module_inst : DUC_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
