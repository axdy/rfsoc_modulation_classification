-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC.vhd
...
ARCHITECTURE rtl OF DUC IS
  ...
  COMPONENT DUC_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT DUC_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DUC_reset_sync
    USE ENTITY work.DUC_reset_sync(rtl);

  FOR ALL : DUC_axi_lite
    USE ENTITY work.DUC_axi_lite(rtl);

  FOR ALL : DUC_axi4_stream_slave
    USE ENTITY work.DUC_axi4_stream_slave(rtl);

  FOR ALL : DUC_dut
    USE ENTITY work.DUC_dut(rtl);

  FOR ALL : DUC_axi4_stream_master
    USE ENTITY work.DUC_axi4_stream_master(rtl);
...
BEGIN
  u_DUC_reset_sync_inst : DUC_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DUC_axi_lite_inst : DUC_axi_lite
  ...
  u_DUC_axi4_stream_slave_inst : DUC_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DUC_axi4_stream_master_inst : DUC_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"89271B28");
