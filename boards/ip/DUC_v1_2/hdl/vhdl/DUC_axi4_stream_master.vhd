-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/ddcduc/DUC_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUC_axi4_stream_master
-- Source Path: DUC/DUC_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DUC_axi4_stream_master IS
...
END DUC_axi4_stream_master;


ARCHITECTURE rtl OF DUC_axi4_stream_master IS

  -- Component Declarations
  COMPONENT DUC_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DUC_fifo_data_OUT
    USE ENTITY work.DUC_fifo_data_OUT(rtl);

  FOR ALL : DUC_fifo_TLAST_OUT
    USE ENTITY work.DUC_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_DUC_fifo_data_OUT_inst : DUC_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DUC_fifo_TLAST_OUT_inst : DUC_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
