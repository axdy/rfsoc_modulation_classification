-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr.vhd
-- Created: 2023-05-29 02:50:02
-- 
...
ARCHITECTURE rtl OF amc_cnn_snr IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_reset_sync
  ...
  COMPONENT amc_cnn_snr_axi_lite
  ...
  COMPONENT amc_cnn_snr_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT amc_cnn_snr_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : amc_cnn_snr_reset_sync
    USE ENTITY work.amc_cnn_snr_reset_sync(rtl);

  FOR ALL : amc_cnn_snr_axi_lite
    USE ENTITY work.amc_cnn_snr_axi_lite(rtl);

  FOR ALL : amc_cnn_snr_axi4_stream_slave
    USE ENTITY work.amc_cnn_snr_axi4_stream_slave(rtl);

  FOR ALL : amc_cnn_snr_dut
    USE ENTITY work.amc_cnn_snr_dut(rtl);

  FOR ALL : amc_cnn_snr_axi4_stream_master
    USE ENTITY work.amc_cnn_snr_axi4_stream_master(rtl);
...
BEGIN
  u_amc_cnn_snr_reset_sync_inst : amc_cnn_snr_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_amc_cnn_snr_axi_lite_inst : amc_cnn_snr_axi_lite
  ...
  u_amc_cnn_snr_axi4_stream_slave_inst : amc_cnn_snr_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_amc_cnn_snr_dut_inst : amc_cnn_snr_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_amc_cnn_snr_axi4_stream_master_inst : amc_cnn_snr_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"8967F009");
