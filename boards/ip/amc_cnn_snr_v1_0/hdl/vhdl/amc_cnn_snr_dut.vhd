-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_dut
-- Source Path: amc_cnn_snr/amc_cnn_snr_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF amc_cnn_snr_dut IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_src_DUT_HDL
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_snr_src_DUT_HDL
    USE ENTITY work.amc_cnn_snr_src_DUT_HDL(rtl);
...
BEGIN
  u_amc_cnn_snr_src_DUT_HDL : amc_cnn_snr_src_DUT_HDL
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
