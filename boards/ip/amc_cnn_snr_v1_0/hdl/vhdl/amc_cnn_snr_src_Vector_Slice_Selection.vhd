-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_src_Vector_Slice_Selection.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_src_Vector_Slice_Selection
...
ENTITY amc_cnn_snr_src_Vector_Slice_Selection IS
...
END amc_cnn_snr_src_Vector_Slice_Selection;


ARCHITECTURE rtl OF amc_cnn_snr_src_Vector_Slice_Selection IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_src_Frame_Slicer
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En8 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En8 [16]
          );
  END COMPONENT;

  COMPONENT amc_cnn_snr_src_Frame_Slicer1
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En8 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En8 [16]
          );
  END COMPONENT;

  COMPONENT amc_cnn_snr_src_Frame_Slicer2
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En8 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En8 [16]
          );
  END COMPONENT;

  COMPONENT amc_cnn_snr_src_Frame_Slicer3
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En8 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En8 [16]
          );
  END COMPONENT;
  ...
  FOR ALL : amc_cnn_snr_src_Frame_Slicer
    USE ENTITY work.amc_cnn_snr_src_Frame_Slicer(rtl);

  FOR ALL : amc_cnn_snr_src_Frame_Slicer1
    USE ENTITY work.amc_cnn_snr_src_Frame_Slicer1(rtl);

  FOR ALL : amc_cnn_snr_src_Frame_Slicer2
    USE ENTITY work.amc_cnn_snr_src_Frame_Slicer2(rtl);

  FOR ALL : amc_cnn_snr_src_Frame_Slicer3
    USE ENTITY work.amc_cnn_snr_src_Frame_Slicer3(rtl);

  -- Signals
  SIGNAL HDL_Counter_out1                 : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL slicedFrame                      : vector_of_std_logic_vector16(0 TO 15);  -- ufix16 [16]
  SIGNAL slicedFrame_signed               : vector_of_signed16(0 TO 15);  -- sfix16_En8 [16]
  SIGNAL slicedFrame_1                    : vector_of_std_logic_vector16(0 TO 15);  -- ufix16 [16]
  SIGNAL slicedFrame_signed_1             : vector_of_signed16(0 TO 15);  -- sfix16_En8 [16]
  SIGNAL slicedFrame_2                    : vector_of_std_logic_vector16(0 TO 15);  -- ufix16 [16]
  SIGNAL slicedFrame_signed_2             : vector_of_signed16(0 TO 15);  -- sfix16_En8 [16]
  SIGNAL slicedFrame_3                    : vector_of_std_logic_vector16(0 TO 15);  -- ufix16 [16]
  SIGNAL slicedFrame_signed_3             : vector_of_signed16(0 TO 15);  -- sfix16_En8 [16]
  SIGNAL Multiport_Switch_out1            : vector_of_signed16(0 TO 15);  -- sfix16_En8 [16]

BEGIN
  u_Frame_Slicer : amc_cnn_snr_src_Frame_Slicer
    PORT MAP( frameIn => frameIn,  -- sfix16_En8 [64]
              slicedFrame => slicedFrame  -- sfix16_En8 [16]
              );

  u_Frame_Slicer1 : amc_cnn_snr_src_Frame_Slicer1
    PORT MAP( frameIn => frameIn,  -- sfix16_En8 [64]
              slicedFrame => slicedFrame_1  -- sfix16_En8 [16]
              );

  u_Frame_Slicer2 : amc_cnn_snr_src_Frame_Slicer2
    PORT MAP( frameIn => frameIn,  -- sfix16_En8 [64]
              slicedFrame => slicedFrame_2  -- sfix16_En8 [16]
              );

  u_Frame_Slicer3 : amc_cnn_snr_src_Frame_Slicer3
    PORT MAP( frameIn => frameIn,  -- sfix16_En8 [64]
              slicedFrame => slicedFrame_3  -- sfix16_En8 [16]
              );
