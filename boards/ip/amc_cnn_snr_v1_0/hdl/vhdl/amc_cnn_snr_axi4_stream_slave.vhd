-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_axi4_stream_slave
-- Source Path: amc_cnn_snr/amc_cnn_snr_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_snr_axi4_stream_slave IS
...
END amc_cnn_snr_axi4_stream_slave;


ARCHITECTURE rtl OF amc_cnn_snr_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_snr_fifo_data
    USE ENTITY work.amc_cnn_snr_fifo_data(rtl);
...
BEGIN
  u_amc_cnn_snr_fifo_data_inst : amc_cnn_snr_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
