-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_axi_lite
-- Source Path: amc_cnn_snr/amc_cnn_snr_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_snr_axi_lite IS
...
END amc_cnn_snr_axi_lite;


ARCHITECTURE rtl OF amc_cnn_snr_axi_lite IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_addr_decoder
  ...
  COMPONENT amc_cnn_snr_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : amc_cnn_snr_addr_decoder
    USE ENTITY work.amc_cnn_snr_addr_decoder(rtl);

  FOR ALL : amc_cnn_snr_axi_lite_module
    USE ENTITY work.amc_cnn_snr_axi_lite_module(rtl);
...
BEGIN
  u_amc_cnn_snr_addr_decoder_inst : amc_cnn_snr_addr_decoder
  ...
  u_amc_cnn_snr_axi_lite_module_inst : amc_cnn_snr_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
