-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_src_BRAM_Storage_Layer_2_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_src_BRAM_Storage_Layer_2_block
...
ENTITY amc_cnn_snr_src_BRAM_Storage_Layer_2_block IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        vectorIn                          :   IN    vector_of_std_logic_vector16(0 TO 15);  -- sfix16_En4 [16]
        ...
        sampleOut                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En4
        validOut                          :   OUT   std_logic
        );
END amc_cnn_snr_src_BRAM_Storage_Layer_2_block;


ARCHITECTURE rtl OF amc_cnn_snr_src_BRAM_Storage_Layer_2_block IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_src_DualPortRAM_generic
  ...
  FOR ALL : amc_cnn_snr_src_DualPortRAM_generic
    USE ENTITY work.amc_cnn_snr_src_DualPortRAM_generic(rtl);
  ...
  SIGNAL vvv                              : signed(15 DOWNTO 0);  -- sfix16_En4
...
BEGIN
  u_RAM_0 : amc_cnn_snr_src_DualPortRAM_generic
  ...
  u_RAM1 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM2 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM3 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM4 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM5 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM6 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM7 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM8 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM9 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM10 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM11 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM12 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM13 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM14 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM15 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
