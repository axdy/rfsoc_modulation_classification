-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_axi4_stream_master
-- Source Path: amc_cnn_snr/amc_cnn_snr_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_snr_axi4_stream_master IS
...
END amc_cnn_snr_axi4_stream_master;


ARCHITECTURE rtl OF amc_cnn_snr_axi4_stream_master IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_snr_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_snr_fifo_data_OUT
    USE ENTITY work.amc_cnn_snr_fifo_data_OUT(rtl);

  FOR ALL : amc_cnn_snr_fifo_TLAST_OUT
    USE ENTITY work.amc_cnn_snr_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_amc_cnn_snr_fifo_data_OUT_inst : amc_cnn_snr_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_amc_cnn_snr_fifo_TLAST_OUT_inst : amc_cnn_snr_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
