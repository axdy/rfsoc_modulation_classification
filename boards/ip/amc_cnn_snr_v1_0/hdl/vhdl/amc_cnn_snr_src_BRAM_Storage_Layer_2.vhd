-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_src_BRAM_Storage_Layer_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_src_BRAM_Storage_Layer_2
...
ENTITY amc_cnn_snr_src_BRAM_Storage_Layer_2 IS
...
END amc_cnn_snr_src_BRAM_Storage_Layer_2;


ARCHITECTURE rtl OF amc_cnn_snr_src_BRAM_Storage_Layer_2 IS
...
BEGIN
  ...
  u_RAM16 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM17 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM18 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM19 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM20 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM21 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM22 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM23 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM24 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM25 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM26 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM27 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM28 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM29 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM30 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM31 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM32 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM33 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM34 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM35 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM36 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM37 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM38 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM39 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM40 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM41 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM42 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM43 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM44 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM45 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM46 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM47 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM48 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM49 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM50 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM51 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM52 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM53 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM54 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM55 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM56 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM57 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM58 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM59 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM60 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM61 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM62 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_RAM63 : amc_cnn_snr_src_DualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
