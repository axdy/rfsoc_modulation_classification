-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_src_adder_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_src_adder_3
-- Source Path: amc_model_w16a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_snr_src_adder_3 IS
...
END amc_cnn_snr_src_adder_3;


ARCHITECTURE rtl OF amc_cnn_snr_src_adder_3 IS
  ...
  SIGNAL s_1                              : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_not1_out    : std_logic;
  SIGNAL switch_compare_1_1               : std_logic;
  SIGNAL In2_signed                       : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL s_2                              : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL Multiply_Accumulate1_input_mux_out : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL In1_signed                       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Multiply_Accumulate1_multiply_out : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_out1        : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_add_fb_in   : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_multiplyAdd_out : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL Multiply_Accumulate1_out1_1      : signed(33 DOWNTO 0);  -- sfix34_En17
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_multiply_out_1 <= to_signed(0, 34);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_out1 <= to_signed(0, 34);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_out1_1 <= to_signed(0, 34);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate1_out1_1(31 DOWNTO 16);
