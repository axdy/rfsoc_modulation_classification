-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_src_Collect_Input_into_Bursts.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_src_Collect_Input_into_Bursts
...
ENTITY amc_cnn_snr_src_Collect_Input_into_Bursts IS
...
END amc_cnn_snr_src_Collect_Input_into_Bursts;


ARCHITECTURE rtl OF amc_cnn_snr_src_Collect_Input_into_Bursts IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_src_Ping_Pong_Buffer_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          validIn                         :   IN    std_logic;
  ...
  COMPONENT amc_cnn_snr_src_SinglePortRAM_generic
  ...
  COMPONENT amc_cnn_snr_src_SinglePortRAM_generic_block
    GENERIC( AddrWidth                    : integer;
             DataWidth                    : integer
             );
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_snr_src_Ping_Pong_Buffer_Controller
    USE ENTITY work.amc_cnn_snr_src_Ping_Pong_Buffer_Controller(rtl);

  FOR ALL : amc_cnn_snr_src_SinglePortRAM_generic
    USE ENTITY work.amc_cnn_snr_src_SinglePortRAM_generic(rtl);

  FOR ALL : amc_cnn_snr_src_SinglePortRAM_generic_block
    USE ENTITY work.amc_cnn_snr_src_SinglePortRAM_generic_block(rtl);
...
BEGIN
  u_Ping_Pong_Buffer_Controller : amc_cnn_snr_src_Ping_Pong_Buffer_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              validIn => validIn,
  ...
  u_Ping_Pong_Buffer_1 : amc_cnn_snr_src_SinglePortRAM_generic
  ...
  u_Ping_Pong_Buffer_0 : amc_cnn_snr_src_SinglePortRAM_generic_block
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
