-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_snr_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_snr_fifo_TLAST_OUT
-- Source Path: amc_cnn_snr/amc_cnn_snr_axi4_stream_master/amc_cnn_snr_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_snr_fifo_TLAST_OUT IS
...
END amc_cnn_snr_fifo_TLAST_OUT;


ARCHITECTURE rtl OF amc_cnn_snr_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT amc_cnn_snr_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : amc_cnn_snr_SimpleDualPortRAM_singlebit
    USE ENTITY work.amc_cnn_snr_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_amc_cnn_snr_fifo_TLAST_OUT_classic_ram_singlebit : amc_cnn_snr_SimpleDualPortRAM_singlebit
