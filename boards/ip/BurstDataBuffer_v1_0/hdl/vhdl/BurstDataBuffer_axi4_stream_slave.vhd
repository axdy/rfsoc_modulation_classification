-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_axi4_stream_slave
-- Source Path: BurstDataBuffer/BurstDataBuffer_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_axi4_stream_slave IS
...
END BurstDataBuffer_axi4_stream_slave;


ARCHITECTURE rtl OF BurstDataBuffer_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT BurstDataBuffer_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT BurstDataBuffer_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : BurstDataBuffer_fifo_data
    USE ENTITY work.BurstDataBuffer_fifo_data(rtl);

  FOR ALL : BurstDataBuffer_fifo_TLAST
    USE ENTITY work.BurstDataBuffer_fifo_TLAST(rtl);
...
BEGIN
  u_BurstDataBuffer_fifo_data_inst : BurstDataBuffer_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_BurstDataBuffer_fifo_TLAST_inst : BurstDataBuffer_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
