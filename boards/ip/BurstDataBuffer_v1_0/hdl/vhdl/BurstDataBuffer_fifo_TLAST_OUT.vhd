-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_fifo_TLAST_OUT
-- Source Path: BurstDataBuffer/BurstDataBuffer_axi4_stream_master/BurstDataBuffer_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_fifo_TLAST_OUT IS
...
END BurstDataBuffer_fifo_TLAST_OUT;


ARCHITECTURE rtl OF BurstDataBuffer_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT BurstDataBuffer_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : BurstDataBuffer_SimpleDualPortRAM_singlebit
    USE ENTITY work.BurstDataBuffer_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_BurstDataBuffer_fifo_TLAST_OUT_classic_ram_singlebit : BurstDataBuffer_SimpleDualPortRAM_singlebit
