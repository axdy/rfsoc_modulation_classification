-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_fifo_data
-- Source Path: BurstDataBuffer/BurstDataBuffer_axi4_stream_slave/BurstDataBuffer_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_fifo_data IS
...
END BurstDataBuffer_fifo_data;


ARCHITECTURE rtl OF BurstDataBuffer_fifo_data IS
...
BEGIN
  ...
  u_BurstDataBuffer_fifo_data_classic_ram : BurstDataBuffer_SimpleDualPortRAM_generic
