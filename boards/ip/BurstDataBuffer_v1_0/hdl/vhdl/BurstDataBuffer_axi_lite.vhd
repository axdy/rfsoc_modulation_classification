-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_axi_lite.vhd
-- Created: 2023-01-10 15:51:29
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_axi_lite
-- Source Path: BurstDataBuffer/BurstDataBuffer_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_axi_lite IS
...
END BurstDataBuffer_axi_lite;


ARCHITECTURE rtl OF BurstDataBuffer_axi_lite IS

  -- Component Declarations
  COMPONENT BurstDataBuffer_addr_decoder
  ...
  COMPONENT BurstDataBuffer_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : BurstDataBuffer_addr_decoder
    USE ENTITY work.BurstDataBuffer_addr_decoder(rtl);

  FOR ALL : BurstDataBuffer_axi_lite_module
    USE ENTITY work.BurstDataBuffer_axi_lite_module(rtl);
...
BEGIN
  u_BurstDataBuffer_addr_decoder_inst : BurstDataBuffer_addr_decoder
  ...
  u_BurstDataBuffer_axi_lite_module_inst : BurstDataBuffer_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
