-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_fifo_data_OUT
-- Source Path: BurstDataBuffer/BurstDataBuffer_axi4_stream_master/BurstDataBuffer_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_fifo_data_OUT IS
...
END BurstDataBuffer_fifo_data_OUT;


ARCHITECTURE rtl OF BurstDataBuffer_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT BurstDataBuffer_SimpleDualPortRAM_generic
  ...
  FOR ALL : BurstDataBuffer_SimpleDualPortRAM_generic
    USE ENTITY work.BurstDataBuffer_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_BurstDataBuffer_fifo_data_OUT_classic_ram_generic : BurstDataBuffer_SimpleDualPortRAM_generic
