-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/axis_combine/BurstDataBuffer_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: BurstDataBuffer_reset_sync
-- Source Path: BurstDataBuffer/BurstDataBuffer_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY BurstDataBuffer_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END BurstDataBuffer_reset_sync;


ARCHITECTURE rtl OF BurstDataBuffer_reset_sync IS
