-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_axi_lite
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_axi_lite IS
...
END cyclicBuf_ip_axi_lite;


ARCHITECTURE rtl OF cyclicBuf_ip_axi_lite IS

  -- Component Declarations
  COMPONENT cyclicBuf_ip_addr_decoder
  ...
  COMPONENT cyclicBuf_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cyclicBuf_ip_addr_decoder
    USE ENTITY work.cyclicBuf_ip_addr_decoder(rtl);

  FOR ALL : cyclicBuf_ip_axi_lite_module
    USE ENTITY work.cyclicBuf_ip_axi_lite_module(rtl);
...
BEGIN
  u_cyclicBuf_ip_addr_decoder_inst : cyclicBuf_ip_addr_decoder
  ...
  u_cyclicBuf_ip_axi_lite_module_inst : cyclicBuf_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
