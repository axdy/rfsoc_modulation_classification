-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_fifo_data
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_slave/cyclicBuf_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_fifo_data IS
...
END cyclicBuf_ip_fifo_data;


ARCHITECTURE rtl OF cyclicBuf_ip_fifo_data IS
...
BEGIN
  ...
  u_cyclicBuf_ip_fifo_data_classic_ram : cyclicBuf_ip_SimpleDualPortRAM_generic
