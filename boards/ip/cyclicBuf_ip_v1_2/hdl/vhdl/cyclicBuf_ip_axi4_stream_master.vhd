-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_axi4_stream_master
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_axi4_stream_master IS
...
END cyclicBuf_ip_axi4_stream_master;


ARCHITECTURE rtl OF cyclicBuf_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT cyclicBuf_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBuf_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBuf_ip_fifo_data_OUT
    USE ENTITY work.cyclicBuf_ip_fifo_data_OUT(rtl);

  FOR ALL : cyclicBuf_ip_fifo_TLAST_OUT
    USE ENTITY work.cyclicBuf_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_cyclicBuf_ip_fifo_data_OUT_inst : cyclicBuf_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBuf_ip_fifo_TLAST_OUT_inst : cyclicBuf_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
