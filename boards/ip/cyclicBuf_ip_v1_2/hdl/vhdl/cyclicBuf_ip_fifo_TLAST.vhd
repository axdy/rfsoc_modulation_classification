-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_fifo_TLAST
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_slave/cyclicBuf_ip_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_fifo_TLAST IS
...
END cyclicBuf_ip_fifo_TLAST;


ARCHITECTURE rtl OF cyclicBuf_ip_fifo_TLAST IS
...
BEGIN
  ...
  u_cyclicBuf_ip_fifo_TLAST_classic_ram : cyclicBuf_ip_SimpleDualPortRAM_singlebit
