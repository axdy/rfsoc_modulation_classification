-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_src_cyclicBuffer.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_src_cyclicBuffer
...
USE work.cyclicBuf_ip_src_cyclicBuffer_pkg.ALL;

ENTITY cyclicBuf_ip_src_cyclicBuffer IS
...
END cyclicBuf_ip_src_cyclicBuffer;


ARCHITECTURE rtl OF cyclicBuf_ip_src_cyclicBuffer IS
  ...
  COMPONENT cyclicBuf_ip_src_Memory_Controller
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          validIn                         :   IN    std_logic;
  ...
  COMPONENT cyclicBuf_ip_src_SinglePortRAM_generic
  ...
  FOR ALL : cyclicBuf_ip_src_Memory_Controller
    USE ENTITY work.cyclicBuf_ip_src_Memory_Controller(rtl);

  FOR ALL : cyclicBuf_ip_src_SinglePortRAM_generic
    USE ENTITY work.cyclicBuf_ip_src_SinglePortRAM_generic(rtl);
...
BEGIN
  u_Memory_Controller : cyclicBuf_ip_src_Memory_Controller
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              validIn => Delay9_out1,
  ...
  u_Single_Port_RAM_System : cyclicBuf_ip_src_SinglePortRAM_generic
