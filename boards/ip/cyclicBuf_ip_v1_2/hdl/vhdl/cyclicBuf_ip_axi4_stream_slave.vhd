-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_axi4_stream_slave
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_axi4_stream_slave IS
...
END cyclicBuf_ip_axi4_stream_slave;


ARCHITECTURE rtl OF cyclicBuf_ip_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT cyclicBuf_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBuf_ip_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBuf_ip_fifo_data
    USE ENTITY work.cyclicBuf_ip_fifo_data(rtl);

  FOR ALL : cyclicBuf_ip_fifo_TLAST
    USE ENTITY work.cyclicBuf_ip_fifo_TLAST(rtl);
...
BEGIN
  u_cyclicBuf_ip_fifo_data_inst : cyclicBuf_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBuf_ip_fifo_TLAST_inst : cyclicBuf_ip_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
