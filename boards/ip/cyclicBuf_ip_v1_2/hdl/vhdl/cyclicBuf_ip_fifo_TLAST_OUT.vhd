-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_fifo_TLAST_OUT
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_master/cyclicBuf_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_fifo_TLAST_OUT IS
...
END cyclicBuf_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF cyclicBuf_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT cyclicBuf_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : cyclicBuf_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.cyclicBuf_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_cyclicBuf_ip_fifo_TLAST_OUT_classic_ram_singlebit : cyclicBuf_ip_SimpleDualPortRAM_singlebit
