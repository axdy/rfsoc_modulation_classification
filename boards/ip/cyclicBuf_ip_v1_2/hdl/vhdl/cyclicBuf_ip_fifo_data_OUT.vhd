-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuf_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuf_ip_fifo_data_OUT
-- Source Path: cyclicBuf_ip/cyclicBuf_ip_axi4_stream_master/cyclicBuf_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuf_ip_fifo_data_OUT IS
...
END cyclicBuf_ip_fifo_data_OUT;


ARCHITECTURE rtl OF cyclicBuf_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT cyclicBuf_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : cyclicBuf_ip_SimpleDualPortRAM_generic
    USE ENTITY work.cyclicBuf_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_cyclicBuf_ip_fifo_data_OUT_classic_ram_generic : cyclicBuf_ip_SimpleDualPortRAM_generic
