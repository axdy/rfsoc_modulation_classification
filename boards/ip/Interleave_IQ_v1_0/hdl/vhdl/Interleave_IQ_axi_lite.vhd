-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/interleaver/Interleave_IQ_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Interleave_IQ_axi_lite
-- Source Path: Interleave_IQ/Interleave_IQ_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Interleave_IQ_axi_lite IS
...
END Interleave_IQ_axi_lite;


ARCHITECTURE rtl OF Interleave_IQ_axi_lite IS

  -- Component Declarations
  COMPONENT Interleave_IQ_addr_decoder
  ...
  COMPONENT Interleave_IQ_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Interleave_IQ_addr_decoder
    USE ENTITY work.Interleave_IQ_addr_decoder(rtl);

  FOR ALL : Interleave_IQ_axi_lite_module
    USE ENTITY work.Interleave_IQ_axi_lite_module(rtl);
...
BEGIN
  u_Interleave_IQ_addr_decoder_inst : Interleave_IQ_addr_decoder
  ...
  u_Interleave_IQ_axi_lite_module_inst : Interleave_IQ_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
