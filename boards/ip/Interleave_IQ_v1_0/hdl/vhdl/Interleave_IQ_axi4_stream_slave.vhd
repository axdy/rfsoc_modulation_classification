-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/interleaver/Interleave_IQ_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Interleave_IQ_axi4_stream_slave
-- Source Path: Interleave_IQ/Interleave_IQ_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Interleave_IQ_axi4_stream_slave IS
...
END Interleave_IQ_axi4_stream_slave;


ARCHITECTURE rtl OF Interleave_IQ_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT Interleave_IQ_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Interleave_IQ_fifo_data
    USE ENTITY work.Interleave_IQ_fifo_data(rtl);
...
BEGIN
  u_Interleave_IQ_fifo_data_inst : Interleave_IQ_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
