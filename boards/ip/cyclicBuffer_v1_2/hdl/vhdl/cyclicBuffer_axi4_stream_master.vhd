-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_axi4_stream_master
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_axi4_stream_master IS
...
END cyclicBuffer_axi4_stream_master;


ARCHITECTURE rtl OF cyclicBuffer_axi4_stream_master IS

  -- Component Declarations
  COMPONENT cyclicBuffer_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBuffer_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBuffer_fifo_data_OUT
    USE ENTITY work.cyclicBuffer_fifo_data_OUT(rtl);

  FOR ALL : cyclicBuffer_fifo_TLAST_OUT
    USE ENTITY work.cyclicBuffer_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_cyclicBuffer_fifo_data_OUT_inst : cyclicBuffer_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBuffer_fifo_TLAST_OUT_inst : cyclicBuffer_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
