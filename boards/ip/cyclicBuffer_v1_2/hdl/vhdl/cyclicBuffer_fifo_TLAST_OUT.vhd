-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_fifo_TLAST_OUT
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_master/cyclicBuffer_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_fifo_TLAST_OUT IS
...
END cyclicBuffer_fifo_TLAST_OUT;


ARCHITECTURE rtl OF cyclicBuffer_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT cyclicBuffer_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : cyclicBuffer_SimpleDualPortRAM_singlebit
    USE ENTITY work.cyclicBuffer_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_cyclicBuffer_fifo_TLAST_OUT_classic_ram_singlebit : cyclicBuffer_SimpleDualPortRAM_singlebit
