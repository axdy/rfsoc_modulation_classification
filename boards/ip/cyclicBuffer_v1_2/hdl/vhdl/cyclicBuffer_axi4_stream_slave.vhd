-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_axi4_stream_slave
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_axi4_stream_slave IS
...
END cyclicBuffer_axi4_stream_slave;


ARCHITECTURE rtl OF cyclicBuffer_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT cyclicBuffer_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBuffer_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBuffer_fifo_data
    USE ENTITY work.cyclicBuffer_fifo_data(rtl);

  FOR ALL : cyclicBuffer_fifo_TLAST
    USE ENTITY work.cyclicBuffer_fifo_TLAST(rtl);
...
BEGIN
  u_cyclicBuffer_fifo_data_inst : cyclicBuffer_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBuffer_fifo_TLAST_inst : cyclicBuffer_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
