-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_fifo_TLAST
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_slave/cyclicBuffer_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_fifo_TLAST IS
...
END cyclicBuffer_fifo_TLAST;


ARCHITECTURE rtl OF cyclicBuffer_fifo_TLAST IS
...
BEGIN
  ...
  u_cyclicBuffer_fifo_TLAST_classic_ram : cyclicBuffer_SimpleDualPortRAM_singlebit
