-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_axi_lite
-- Source Path: cyclicBuffer/cyclicBuffer_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_axi_lite IS
...
END cyclicBuffer_axi_lite;


ARCHITECTURE rtl OF cyclicBuffer_axi_lite IS

  -- Component Declarations
  COMPONENT cyclicBuffer_addr_decoder
  ...
  COMPONENT cyclicBuffer_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cyclicBuffer_addr_decoder
    USE ENTITY work.cyclicBuffer_addr_decoder(rtl);

  FOR ALL : cyclicBuffer_axi_lite_module
    USE ENTITY work.cyclicBuffer_axi_lite_module(rtl);
...
BEGIN
  u_cyclicBuffer_addr_decoder_inst : cyclicBuffer_addr_decoder
  ...
  u_cyclicBuffer_axi_lite_module_inst : cyclicBuffer_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
