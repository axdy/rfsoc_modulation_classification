-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_fifo_data
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_slave/cyclicBuffer_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_fifo_data IS
...
END cyclicBuffer_fifo_data;


ARCHITECTURE rtl OF cyclicBuffer_fifo_data IS
...
BEGIN
  ...
  u_cyclicBuffer_fifo_data_classic_ram : cyclicBuffer_SimpleDualPortRAM_generic
