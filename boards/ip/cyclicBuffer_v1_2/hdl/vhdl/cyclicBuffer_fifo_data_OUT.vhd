-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBuffer_fifo_data_OUT
-- Source Path: cyclicBuffer/cyclicBuffer_axi4_stream_master/cyclicBuffer_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBuffer_fifo_data_OUT IS
...
END cyclicBuffer_fifo_data_OUT;


ARCHITECTURE rtl OF cyclicBuffer_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT cyclicBuffer_SimpleDualPortRAM_generic
  ...
  FOR ALL : cyclicBuffer_SimpleDualPortRAM_generic
    USE ENTITY work.cyclicBuffer_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_cyclicBuffer_fifo_data_OUT_classic_ram_generic : cyclicBuffer_SimpleDualPortRAM_generic
