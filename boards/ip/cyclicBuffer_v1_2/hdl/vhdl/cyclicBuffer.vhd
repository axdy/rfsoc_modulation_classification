-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBuffer/cyclicBuffer.vhd
...
ARCHITECTURE rtl OF cyclicBuffer IS

  -- Component Declarations
  COMPONENT cyclicBuffer_axi4_stream_slave
  ...
  COMPONENT cyclicBuffer_reset_sync
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT cyclicBuffer_axi_lite
  ...
  COMPONENT cyclicBuffer_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cyclicBuffer_axi4_stream_slave
    USE ENTITY work.cyclicBuffer_axi4_stream_slave(rtl);

  FOR ALL : cyclicBuffer_reset_sync
    USE ENTITY work.cyclicBuffer_reset_sync(rtl);

  FOR ALL : cyclicBuffer_axi_lite
    USE ENTITY work.cyclicBuffer_axi_lite(rtl);

  FOR ALL : cyclicBuffer_dut
    USE ENTITY work.cyclicBuffer_dut(rtl);

  FOR ALL : cyclicBuffer_axi4_stream_master
    USE ENTITY work.cyclicBuffer_axi4_stream_master(rtl);
...
BEGIN
  u_cyclicBuffer_axi4_stream_slave_inst : cyclicBuffer_axi4_stream_slave
  ...
  u_cyclicBuffer_reset_sync_inst : cyclicBuffer_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_cyclicBuffer_axi_lite_inst : cyclicBuffer_axi_lite
  ...
  u_cyclicBuffer_dut_inst : cyclicBuffer_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_cyclicBuffer_axi4_stream_master_inst : cyclicBuffer_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"83AEA75F");
