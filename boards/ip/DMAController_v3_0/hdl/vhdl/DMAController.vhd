-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController.vhd
...
ARCHITECTURE rtl OF DMAController IS

  -- Component Declarations
  COMPONENT DMAController_reset_sync
  ...
  COMPONENT DMAController_axi_lite
  ...
  COMPONENT DMAController_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT DMAController_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DMAController_reset_sync
    USE ENTITY work.DMAController_reset_sync(rtl);

  FOR ALL : DMAController_axi_lite
    USE ENTITY work.DMAController_axi_lite(rtl);

  FOR ALL : DMAController_axi4_stream_slave
    USE ENTITY work.DMAController_axi4_stream_slave(rtl);

  FOR ALL : DMAController_dut
    USE ENTITY work.DMAController_dut(rtl);

  FOR ALL : DMAController_axi4_stream_master
    USE ENTITY work.DMAController_axi4_stream_master(rtl);
  ...
  SIGNAL write_ready_dma                  : std_logic;  -- ufix1
...
BEGIN
  u_DMAController_reset_sync_inst : DMAController_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DMAController_axi_lite_inst : DMAController_axi_lite
    PORT MAP( reset => reset,
              ...
              write_ready_dma => write_ready_dma,  -- ufix1
              reset_internal => reset_internal  -- ufix1
              );

  u_DMAController_axi4_stream_slave_inst : DMAController_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DMAController_dut_inst : DMAController_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              ...
              ready_dma => write_ready_dma,  -- ufix1
  ...
  u_DMAController_axi4_stream_master_inst : DMAController_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"892A2BBD");
