-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_fifo_data
-- Source Path: DMAController/DMAController_axi4_stream_slave/DMAController_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_fifo_data IS
...
END DMAController_fifo_data;


ARCHITECTURE rtl OF DMAController_fifo_data IS
...
BEGIN
  ...
  u_DMAController_fifo_data_classic_ram : DMAController_SimpleDualPortRAM_generic
