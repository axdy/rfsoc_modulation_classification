-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_axi4_stream_slave
-- Source Path: DMAController/DMAController_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_axi4_stream_slave IS
...
END DMAController_axi4_stream_slave;


ARCHITECTURE rtl OF DMAController_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT DMAController_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DMAController_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DMAController_fifo_data
    USE ENTITY work.DMAController_fifo_data(rtl);

  FOR ALL : DMAController_fifo_TLAST
    USE ENTITY work.DMAController_fifo_TLAST(rtl);
...
BEGIN
  u_DMAController_fifo_data_inst : DMAController_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DMAController_fifo_TLAST_inst : DMAController_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
