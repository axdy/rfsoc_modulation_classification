-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16/amc_cnn_16w16a_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_src_adder_0_block
-- Source Path: amc_model_w16a16/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_src_adder_0_block IS
...
END amc_cnn_16w16a_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_16w16a_src_adder_0_block IS
  ...
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg : vector_of_signed32(0 TO 1);  -- sfix32 [2]
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg_next : vector_of_signed32(0 TO 1);  -- sfix32_En15 [2]
  SIGNAL Multiply_Accumulate_out1_2       : signed(31 DOWNTO 0);  -- sfix32_En15
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out3_buff_out_pipe_reg(0) <= to_signed(0, 32);
        Multiply_Accumulate_out3_buff_out_pipe_reg(1) <= to_signed(0, 32);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_2(22 DOWNTO 7);
