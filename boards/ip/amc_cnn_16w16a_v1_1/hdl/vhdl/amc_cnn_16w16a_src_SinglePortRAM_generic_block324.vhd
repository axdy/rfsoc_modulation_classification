...
ARCHITECTURE rtl OF amc_cnn_16w16a_src_SinglePortRAM_generic_block324 IS
  ...
  -- Signals
  SIGNAL ram                              : ram_type := (X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"fead", X"f00b", X"f012", X"0b2c", X"ee42", X"2399",
                                                        X"264e", X"1a74", X"082f", X"290d", X"304e", X"2780", X"fb24", X"0b63", X"c5f9", X"f300", X"03d1", X"c7ac", X"f5c3", X"dfc1",
                                                        X"08a4", X"eb10", X"0c1f", X"0125");
  SIGNAL data_int                         : std_logic_vector(DataWidth - 1 DOWNTO 0) := X"0125";
