...
ARCHITECTURE rtl OF amc_cnn_16w16a_src_SinglePortRAM_generic_block85 IS
  ...
  -- Signals
  SIGNAL ram                              : ram_type := (X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"011e", X"164c", X"0b1f", X"e373", X"f7ce", X"0ad8",
                                                        X"fac3", X"ff10", X"0153", X"0c5c", X"e760", X"09c4", X"0c62", X"0767", X"f9d3", X"f399", X"f493", X"d84a", X"1705", X"f413",
                                                        X"e72d", X"f234", X"2652", X"1f03");
  SIGNAL data_int                         : std_logic_vector(DataWidth - 1 DOWNTO 0) := X"1f03";
