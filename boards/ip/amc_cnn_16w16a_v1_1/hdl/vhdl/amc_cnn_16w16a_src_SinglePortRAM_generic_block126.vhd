...
ARCHITECTURE rtl OF amc_cnn_16w16a_src_SinglePortRAM_generic_block126 IS
  ...
  -- Signals
  SIGNAL ram                              : ram_type := (X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"2c82", X"d906", X"2750", X"e299", X"ed97", X"dd15",
                                                        X"def7", X"fb0b", X"2726", X"d30f", X"c6f4", X"c035", X"06e8", X"fe87", X"3fc0", X"e747", X"2004", X"c32b", X"cab6", X"1f08",
                                                        X"1e0d", X"0f4f", X"f8fe", X"048a");
