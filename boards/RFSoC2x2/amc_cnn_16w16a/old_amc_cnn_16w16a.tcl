...
user.org:ip:amc_cnn_16w16a:1.0\
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  set amc_cnn [ create_bd_cell -type ip -vlnv user.org:ip:amc_cnn_16w16a:1.0 amc_cnn ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins AXI4_Lite5] [get_bd_intf_pins amc_cnn/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net cnn_interleave_0_AXI4_Stream_Master [get_bd_intf_pins Interleave_IQ/AXI4_Stream_Master] [get_bd_intf_pins amc_cnn/AXI4_Stream_Slave]
  connect_bd_intf_net -intf_net [get_bd_intf_nets cnn_interleave_0_AXI4_Stream_Master] [get_bd_intf_pins AXI4_Stream_Slave] [get_bd_intf_pins Interleave_IQ/AXI4_Stream_Master]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets cnn_interleave_0_AXI4_Stream_Master]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfdc_real] [get_bd_intf_pins receiver/S00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/amc_cnn/AXI4_Lite/reg0] -force
