...
################################################################
# This is a generated script based on design: bd_3a13
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXIS:SLOT_10_AXIS:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS:SLOT_4_AXIS:SLOT_5_AXIS:SLOT_6_AXIS:SLOT_7_AXIS:SLOT_8_AXIS:SLOT_9_AXIS} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_10_AXIS_TDATA_WIDTH {16} \
   ...
   CONFIG.C_SLOT_8_AXIS_TDATA_WIDTH {16} \
   ...
   CONFIG.C_SLOT_8_HAS_TREADY {0} \
   CONFIG.C_SLOT_8_HAS_TSTRB {0} \
   CONFIG.C_SLOT_8_MON_MODE {FT} \
   CONFIG.C_SLOT_9_AXIS_TDATA_WIDTH {16} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {128000000} \
...
connect_bd_intf_net -intf_net Conn10 [get_bd_intf_ports SLOT_10_AXIS] [get_bd_intf_pins g_inst/slot_10_axis]
  ...
  connect_bd_net -net net_slot_10_axis_tdata [get_bd_pins g_inst/m_slot_10_axis_tdata] [get_bd_pins ila_lib/probe43]
  connect_bd_net -net net_slot_10_axis_tlast [get_bd_pins g_inst/m_slot_10_axis_tlast] [get_bd_pins ila_lib/probe46]
  connect_bd_net -net net_slot_10_axis_tready [get_bd_pins g_inst/m_slot_10_axis_tready] [get_bd_pins ila_lib/probe45]
  connect_bd_net -net net_slot_10_axis_tvalid [get_bd_pins g_inst/m_slot_10_axis_tvalid] [get_bd_pins ila_lib/probe44]
  ...
  connect_bd_net -net net_slot_2_axis_tdata [get_bd_pins g_inst/m_slot_2_axis_tdata] [get_bd_pins ila_lib/probe13]
  ...
  connect_bd_net -net net_slot_3_axis_tdata [get_bd_pins g_inst/m_slot_3_axis_tdata] [get_bd_pins ila_lib/probe17]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_3_axis_tlast] [get_bd_pins ila_lib/probe20]
  connect_bd_net -net net_slot_3_axis_tready [get_bd_pins g_inst/m_slot_3_axis_tready] [get_bd_pins ila_lib/probe19]
  connect_bd_net -net net_slot_3_axis_tvalid [get_bd_pins g_inst/m_slot_3_axis_tvalid] [get_bd_pins ila_lib/probe18]
  connect_bd_net -net net_slot_4_axis_tdata [get_bd_pins g_inst/m_slot_4_axis_tdata] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_4_axis_tlast [get_bd_pins g_inst/m_slot_4_axis_tlast] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net net_slot_4_axis_tready [get_bd_pins g_inst/m_slot_4_axis_tready] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_4_axis_tvalid [get_bd_pins g_inst/m_slot_4_axis_tvalid] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net net_slot_5_axis_tdata [get_bd_pins g_inst/m_slot_5_axis_tdata] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_5_axis_tlast [get_bd_pins g_inst/m_slot_5_axis_tlast] [get_bd_pins ila_lib/probe28]
  connect_bd_net -net net_slot_5_axis_tready [get_bd_pins g_inst/m_slot_5_axis_tready] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_5_axis_tvalid [get_bd_pins g_inst/m_slot_5_axis_tvalid] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_6_axis_tdata [get_bd_pins g_inst/m_slot_6_axis_tdata] [get_bd_pins ila_lib/probe29]
  connect_bd_net -net net_slot_6_axis_tlast [get_bd_pins g_inst/m_slot_6_axis_tlast] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_6_axis_tready [get_bd_pins g_inst/m_slot_6_axis_tready] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_6_axis_tvalid [get_bd_pins g_inst/m_slot_6_axis_tvalid] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_7_axis_tdata [get_bd_pins g_inst/m_slot_7_axis_tdata] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_7_axis_tlast [get_bd_pins g_inst/m_slot_7_axis_tlast] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_7_axis_tready [get_bd_pins g_inst/m_slot_7_axis_tready] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_7_axis_tvalid [get_bd_pins g_inst/m_slot_7_axis_tvalid] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_8_axis_tdata [get_bd_pins g_inst/m_slot_8_axis_tdata] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_8_axis_tlast [get_bd_pins g_inst/m_slot_8_axis_tlast] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_8_axis_tvalid [get_bd_pins g_inst/m_slot_8_axis_tvalid] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_9_axis_tdata [get_bd_pins g_inst/m_slot_9_axis_tdata] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_9_axis_tlast [get_bd_pins g_inst/m_slot_9_axis_tlast] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net net_slot_9_axis_tvalid [get_bd_pins g_inst/m_slot_9_axis_tvalid] [get_bd_pins ila_lib/probe41]
