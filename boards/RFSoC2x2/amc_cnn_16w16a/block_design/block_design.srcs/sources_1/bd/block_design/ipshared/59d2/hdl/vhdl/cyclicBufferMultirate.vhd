-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate
-- Source Path: cyclicBufferMultirate
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate IS
...
END cyclicBufferMultirate;


ARCHITECTURE rtl OF cyclicBufferMultirate IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_axi4_stream_slave
  ...
  COMPONENT cyclicBufferMultirate_reset_sync
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT cyclicBufferMultirate_axi_lite
  ...
  COMPONENT cyclicBufferMultirate_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT cyclicBufferMultirate_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cyclicBufferMultirate_axi4_stream_slave
    USE ENTITY work.cyclicBufferMultirate_axi4_stream_slave(rtl);

  FOR ALL : cyclicBufferMultirate_reset_sync
    USE ENTITY work.cyclicBufferMultirate_reset_sync(rtl);

  FOR ALL : cyclicBufferMultirate_axi_lite
    USE ENTITY work.cyclicBufferMultirate_axi_lite(rtl);

  FOR ALL : cyclicBufferMultirate_dut
    USE ENTITY work.cyclicBufferMultirate_dut(rtl);

  FOR ALL : cyclicBufferMultirate_axi4_stream_master
    USE ENTITY work.cyclicBufferMultirate_axi4_stream_master(rtl);
...
BEGIN
  u_cyclicBufferMultirate_axi4_stream_slave_inst : cyclicBufferMultirate_axi4_stream_slave
  ...
  u_cyclicBufferMultirate_reset_sync_inst : cyclicBufferMultirate_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_cyclicBufferMultirate_axi_lite_inst : cyclicBufferMultirate_axi_lite
  ...
  u_cyclicBufferMultirate_dut_inst : cyclicBufferMultirate_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_cyclicBufferMultirate_axi4_stream_master_inst : cyclicBufferMultirate_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"83DB8457");
