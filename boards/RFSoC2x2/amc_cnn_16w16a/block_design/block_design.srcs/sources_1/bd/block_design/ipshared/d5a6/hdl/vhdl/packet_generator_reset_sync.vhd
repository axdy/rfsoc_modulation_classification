-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/packet_generator/packet_generator_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: packet_generator_reset_sync
-- Source Path: packet_generator/packet_generator_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY packet_generator_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END packet_generator_reset_sync;


ARCHITECTURE rtl OF packet_generator_reset_sync IS
