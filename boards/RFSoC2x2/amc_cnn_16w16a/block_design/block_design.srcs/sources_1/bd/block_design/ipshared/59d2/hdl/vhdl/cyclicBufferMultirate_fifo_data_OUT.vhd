-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_fifo_data_OUT
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_master/cyclicBufferMultirate_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_fifo_data_OUT IS
...
END cyclicBufferMultirate_fifo_data_OUT;


ARCHITECTURE rtl OF cyclicBufferMultirate_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_SimpleDualPortRAM_generic
  ...
  FOR ALL : cyclicBufferMultirate_SimpleDualPortRAM_generic
    USE ENTITY work.cyclicBufferMultirate_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_cyclicBufferMultirate_fifo_data_OUT_classic_ram_generic : cyclicBufferMultirate_SimpleDualPortRAM_generic
