-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_axi4_stream_slave
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_axi4_stream_slave IS
...
END cyclicBufferMultirate_axi4_stream_slave;


ARCHITECTURE rtl OF cyclicBufferMultirate_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBufferMultirate_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBufferMultirate_fifo_data
    USE ENTITY work.cyclicBufferMultirate_fifo_data(rtl);

  FOR ALL : cyclicBufferMultirate_fifo_TLAST
    USE ENTITY work.cyclicBufferMultirate_fifo_TLAST(rtl);
...
BEGIN
  u_cyclicBufferMultirate_fifo_data_inst : cyclicBufferMultirate_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBufferMultirate_fifo_TLAST_inst : cyclicBufferMultirate_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
