-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_axi_lite
-- Source Path: DMAController/DMAController_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_axi_lite IS
...
END DMAController_axi_lite;


ARCHITECTURE rtl OF DMAController_axi_lite IS

  -- Component Declarations
  COMPONENT DMAController_addr_decoder
  ...
  COMPONENT DMAController_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DMAController_addr_decoder
    USE ENTITY work.DMAController_addr_decoder(rtl);

  FOR ALL : DMAController_axi_lite_module
    USE ENTITY work.DMAController_axi_lite_module(rtl);
...
BEGIN
  u_DMAController_addr_decoder_inst : DMAController_addr_decoder
  ...
  u_DMAController_axi_lite_module_inst : DMAController_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
