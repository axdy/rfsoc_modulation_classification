-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_fifo_data
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_slave/cyclicBufferMultirate_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_fifo_data IS
...
END cyclicBufferMultirate_fifo_data;


ARCHITECTURE rtl OF cyclicBufferMultirate_fifo_data IS
...
BEGIN
  ...
  u_cyclicBufferMultirate_fifo_data_classic_ram : cyclicBufferMultirate_SimpleDualPortRAM_generic
