-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/packet_generator/packet_generator_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: packet_generator_fifo_data_OUT
-- Source Path: packet_generator/packet_generator_axi4_stream_master/packet_generator_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY packet_generator_fifo_data_OUT IS
...
END packet_generator_fifo_data_OUT;


ARCHITECTURE rtl OF packet_generator_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT packet_generator_SimpleDualPortRAM_generic
  ...
  FOR ALL : packet_generator_SimpleDualPortRAM_generic
    USE ENTITY work.packet_generator_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_packet_generator_fifo_data_OUT_classic_ram_generic : packet_generator_SimpleDualPortRAM_generic
