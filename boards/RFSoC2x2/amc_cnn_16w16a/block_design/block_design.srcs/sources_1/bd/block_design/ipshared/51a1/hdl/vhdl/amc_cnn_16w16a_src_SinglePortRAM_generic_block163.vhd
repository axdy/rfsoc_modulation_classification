...
ARCHITECTURE rtl OF amc_cnn_16w16a_src_SinglePortRAM_generic_block163 IS
  ...
  -- Signals
  SIGNAL ram                              : ram_type := (X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"0000", X"b3e1", X"eac1", X"e5da", X"395a", X"c1fa", X"3f15",
                                                        X"5eaa", X"f511", X"4bcb", X"3900", X"aa8c", X"f06b", X"eb7c", X"c3bf", X"2d97", X"b767", X"2200", X"59fb", X"6c39", X"d91a",
                                                        X"b378", X"30cc", X"27ff", X"727b");
  SIGNAL data_int                         : std_logic_vector(DataWidth - 1 DOWNTO 0) := X"727b";
