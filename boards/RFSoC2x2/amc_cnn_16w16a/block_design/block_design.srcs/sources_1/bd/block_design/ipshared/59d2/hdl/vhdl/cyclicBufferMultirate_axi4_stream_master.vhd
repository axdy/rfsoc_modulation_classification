-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_axi4_stream_master
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_axi4_stream_master IS
...
END cyclicBufferMultirate_axi4_stream_master;


ARCHITECTURE rtl OF cyclicBufferMultirate_axi4_stream_master IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT cyclicBufferMultirate_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : cyclicBufferMultirate_fifo_data_OUT
    USE ENTITY work.cyclicBufferMultirate_fifo_data_OUT(rtl);

  FOR ALL : cyclicBufferMultirate_fifo_TLAST_OUT
    USE ENTITY work.cyclicBufferMultirate_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_cyclicBufferMultirate_fifo_data_OUT_inst : cyclicBufferMultirate_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_cyclicBufferMultirate_fifo_TLAST_OUT_inst : cyclicBufferMultirate_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
