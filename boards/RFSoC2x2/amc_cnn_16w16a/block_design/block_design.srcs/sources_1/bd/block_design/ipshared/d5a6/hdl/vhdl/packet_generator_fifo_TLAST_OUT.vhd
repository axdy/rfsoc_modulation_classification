-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/packet_generator/packet_generator_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: packet_generator_fifo_TLAST_OUT
-- Source Path: packet_generator/packet_generator_axi4_stream_master/packet_generator_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY packet_generator_fifo_TLAST_OUT IS
...
END packet_generator_fifo_TLAST_OUT;


ARCHITECTURE rtl OF packet_generator_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT packet_generator_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : packet_generator_SimpleDualPortRAM_singlebit
    USE ENTITY work.packet_generator_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_packet_generator_fifo_TLAST_OUT_classic_ram_singlebit : packet_generator_SimpleDualPortRAM_singlebit
