-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/cyclicBufferMultirate/cyclicBufferMultirate_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: cyclicBufferMultirate_axi_lite
-- Source Path: cyclicBufferMultirate/cyclicBufferMultirate_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY cyclicBufferMultirate_axi_lite IS
...
END cyclicBufferMultirate_axi_lite;


ARCHITECTURE rtl OF cyclicBufferMultirate_axi_lite IS

  -- Component Declarations
  COMPONENT cyclicBufferMultirate_addr_decoder
  ...
  COMPONENT cyclicBufferMultirate_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : cyclicBufferMultirate_addr_decoder
    USE ENTITY work.cyclicBufferMultirate_addr_decoder(rtl);

  FOR ALL : cyclicBufferMultirate_axi_lite_module
    USE ENTITY work.cyclicBufferMultirate_axi_lite_module(rtl);
...
BEGIN
  u_cyclicBufferMultirate_addr_decoder_inst : cyclicBufferMultirate_addr_decoder
  ...
  u_cyclicBufferMultirate_axi_lite_module_inst : cyclicBufferMultirate_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
