-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_fifo_TLAST_OUT
-- Source Path: DMAController/DMAController_axi4_stream_master/DMAController_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_fifo_TLAST_OUT IS
...
END DMAController_fifo_TLAST_OUT;


ARCHITECTURE rtl OF DMAController_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT DMAController_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : DMAController_SimpleDualPortRAM_singlebit
    USE ENTITY work.DMAController_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_DMAController_fifo_TLAST_OUT_classic_ram_singlebit : DMAController_SimpleDualPortRAM_singlebit
