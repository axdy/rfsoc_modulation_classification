...
--               /home/andy/Documents/PhD/Development/amc_quant_compare/boards/RFSoC2x2/amc_cnn_16w16a/block_design/block_design.srcs/sources_1/bd/block_design/ip/block_design_adc0_clk_wiz_0/block_design_adc0_clk_wiz_0_sim_netlist.vhdl
...
entity block_design_adc0_clk_wiz_0_block_design_adc0_clk_wiz_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of block_design_adc0_clk_wiz_0_block_design_adc0_clk_wiz_0_clk_wiz : entity is "block_design_adc0_clk_wiz_0_clk_wiz";
end block_design_adc0_clk_wiz_0_block_design_adc0_clk_wiz_0_clk_wiz;

architecture STRUCTURE of block_design_adc0_clk_wiz_0_block_design_adc0_clk_wiz_0_clk_wiz is
  signal clk_in1_block_design_adc0_clk_wiz_0 : STD_LOGIC;
  signal clk_out1_block_design_adc0_clk_wiz_0 : STD_LOGIC;
  signal clk_out2_block_design_adc0_clk_wiz_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_block_design_adc0_clk_wiz_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_block_design_adc0_clk_wiz_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_block_design_adc0_clk_wiz_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_block_design_adc0_clk_wiz_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_block_design_adc0_clk_wiz_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_block_design_adc0_clk_wiz_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity block_design_adc0_clk_wiz_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    resetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of block_design_adc0_clk_wiz_0 : entity is true;
end block_design_adc0_clk_wiz_0;

architecture STRUCTURE of block_design_adc0_clk_wiz_0 is
begin
inst: entity work.block_design_adc0_clk_wiz_0_block_design_adc0_clk_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
