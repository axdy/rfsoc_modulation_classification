-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/interleaver/Interleave_IQ_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Interleave_IQ_fifo_TLAST_OUT
-- Source Path: Interleave_IQ/Interleave_IQ_axi4_stream_master/Interleave_IQ_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Interleave_IQ_fifo_TLAST_OUT IS
...
END Interleave_IQ_fifo_TLAST_OUT;


ARCHITECTURE rtl OF Interleave_IQ_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT Interleave_IQ_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : Interleave_IQ_SimpleDualPortRAM_singlebit
    USE ENTITY work.Interleave_IQ_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_Interleave_IQ_fifo_TLAST_OUT_classic_ram_singlebit : Interleave_IQ_SimpleDualPortRAM_singlebit
