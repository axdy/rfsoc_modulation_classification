-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_fifo_data_OUT
-- Source Path: DMAController/DMAController_axi4_stream_master/DMAController_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_fifo_data_OUT IS
...
END DMAController_fifo_data_OUT;


ARCHITECTURE rtl OF DMAController_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT DMAController_SimpleDualPortRAM_generic
  ...
  FOR ALL : DMAController_SimpleDualPortRAM_generic
    USE ENTITY work.DMAController_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DMAController_fifo_data_OUT_classic_ram_generic : DMAController_SimpleDualPortRAM_generic
