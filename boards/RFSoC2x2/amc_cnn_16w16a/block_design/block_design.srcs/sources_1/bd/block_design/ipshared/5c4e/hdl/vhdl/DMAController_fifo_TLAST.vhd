-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/fifo_packet/DMAController_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DMAController_fifo_TLAST
-- Source Path: DMAController/DMAController_axi4_stream_slave/DMAController_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DMAController_fifo_TLAST IS
...
END DMAController_fifo_TLAST;


ARCHITECTURE rtl OF DMAController_fifo_TLAST IS
...
BEGIN
  ...
  u_DMAController_fifo_TLAST_classic_ram : DMAController_SimpleDualPortRAM_singlebit
